...
ADD https://github.com/dotnet/docfx/releases/download/v2.72.1/docfx-linux-x64-v2.72.1.zip /
RUN unzip docfx-linux-x64-v2.72.1.zip -d /docfx && \
    rm docfx-linux-x64-v2.72.1.zip
